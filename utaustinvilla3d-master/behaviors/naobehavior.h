...
public:
    ...
    // get teammate's number who is the closest to ball
    int nearest2BallTM();
    // get opponent's number who is the closest to ball
    int nearest2BallOP();
    // get teammate's number who is the furthest to ball
    int furthestTM2Ball();
    vector<VecPosition> getDangerOP(vector<int>& numbers);
};
